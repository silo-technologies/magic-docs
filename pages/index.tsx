...
const Home: React.FC<Props> = ({ handlers }) => {
  ...
  return (
    <Viewport>
      <Navbar
        icon="✨"
        title="Magic Handlers"
        subtitle="Directory of API endpoints for silo-go"
      >
...
export async function getServerSideProps() {
  const response = await axios.get<API.HandlerSummary[]>(
    "https://usesilo-stage.herokuapp.com/api/docs/handlers",
    {
      headers: {
  ...
  const handlers = response.data.sort(
